...
int main (int argc, char *argv[]) {
	...
	for(int i = 0; i < 100; i++)
	{
		myAncestry->siblings[i] = 0;
		myAncestry->children[i] = 0;
	}
	for(int i = 0; i < 10; i++)
	{
		myAncestry->ancestors[i] = 0;
	}
	if(argc < 2)
	{
